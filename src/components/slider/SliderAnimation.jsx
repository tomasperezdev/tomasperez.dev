...
const conctInfo = {
  phone: "+1 236-234-6677",
  email: " tppshaka77@gmail.com",
};

const sliderContent = {
  name: "Tomás Pérez",
  designation: "Full-stack Software Engineer",
  description: `I'm passionate about the continous improvement of our reality trough technology.`,
  btnText: " Download CV",
};
    ...
    <>
      ...
      <section id="home" className="home-banner">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${
              process.env.PUBLIC_URL + "img/slider/mybanner.png"
            })`,
          }}
        ></div>
      </section>
